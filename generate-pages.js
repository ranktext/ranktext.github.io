/**
 * ranktext – Programmatic SEO Landingpage Generator
 * Generiert 50 city-spezifische Landingpages
 */

const fs = require('fs');
const path = require('path');

// 50 deutsche Städte mit regionalen Daten
const cities = [
...
function generatePage(city) {
  const urlSlug = `content-agentur-${city.slug}`;
  const title = `Content Agentur ${city.name} | SEO & GEO Texte für KMUs – ranktext`;
  const metaDesc = `ranktext liefert SEO-optimierte Blogartikel und GEO-Content für KMUs in ${city.name}. Ab 399 €/Monat. Monatlich kündbar. ${city.businesses} Unternehmen warten auf bessere Sichtbarkeit.`;
...
<head>
  ...
  <link rel="canonical" href="https://www.ranktext.de/landingpages/${urlSlug}.html">
  <meta property="og:title" content="${title}">
  <meta property="og:description" content="${metaDesc}">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://www.ranktext.de/landingpages/${urlSlug}.html">
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "LocalBusiness",
    "name": "ranktext",
    "description": "SEO & GEO Content Agentur für KMUs in ${city.name} und ${city.state}",
    "url": "https://www.ranktext.de",
    "email": "hallo@ranktext.de",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Ernst-Reuter-Straße 33–37",
    ...
    "offers": {
      "@type": "Offer",
      "name": "Content-Retainer für KMUs",
      "price": "399",
      "priceCurrency": "EUR",
      "description": "Monatliches SEO- & GEO-Content-Paket"
    }
  }
  </script>
</head>
...
<nav id="navbar" role="navigation" aria-label="Hauptnavigation">
  <div class="nav-inner">
    <a href="/" class="nav-logo" aria-label="ranktext Startseite">ranktext</a>
    <ul class="nav-links" id="nav-links" role="list">
      <li><a href="/#leistungen">Leistungen</a></li>
      <li><a href="/#preise">Preise</a></li>
      <li><a href="../blog/index.html">Blog</a></li>
    </ul>
    <a href="https://tally.so/r/ODkbAk" class="btn btn-primary btn-sm nav-cta"
       target="_blank" rel="noopener noreferrer" id="nav-cta-${city.slug}">Jetzt starten</a>
    <button class="nav-toggle" id="nav-toggle" aria-label="Menü öffnen" aria-expanded="false" aria-controls="nav-links">
...
<main>
  ...
  <section class="lp-hero">
    <div class="container">
      <div class="lp-hero-inner">
        <div class="section-badge">Content Agentur ${city.name}</div>
        <h1>SEO-Content für KMUs in ${city.name} — vollautomatisch geliefert</h1>
        <p class="lp-hero-sub">
          ${city.businesses} Unternehmen in ${city.name} kämpfen um Google-Sichtbarkeit. Die, die regelmäßig guten Content veröffentlichen, gewinnen — ohne selbst zu schreiben. ranktext liefert dir monatlich fertige Blog-Artikel und GEO-Content, der rankt.
        </p>
        <div class="lp-hero-cta">
          <a href="https://tally.so/r/ODkbAk" class="btn btn-primary btn-lg"
             target="_blank" rel="noopener noreferrer" id="hero-cta-${city.slug}">
            Paket anfragen – ab 399 €/Monat
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg>
          </a>
    ...
    <div class="container">
      <div class="lp-local-grid">
        <div class="lp-local-text">
          <h2>Warum ${city.name}er KMUs jetzt in Content investieren</h2>
          <p>
            ${city.name} ist ${city.note}. Mit ${city.population} Einwohnern und über ${city.businesses} aktiven Unternehmen ist der lokale Wettbewerb enorm — besonders online. Wer bei Google für relevante Suchbegriffe nicht auf Seite 1 erscheint, wird schlicht nicht gefunden.
          </p>
          <p>
            Das Problem: Die meisten Inhaber in ${city.name} wissen, dass sie Content brauchen — haben aber weder Zeit noch Budget für ein internes Marketing-Team. Eine festangestellte Content-Managerin kostet 3.500 € pro Monat. Ein ranktext-Paket kostet ab 399 € — und liefert mehr.
          </p>
          <p>
            <strong>Vollautomatisch.</strong> Du bekommst monatlich fertige, SEO- und GEO-optimierte Blogartikel — veröffentlichungsfertig, branchenspezifisch, ohne einen einzigen Handgriff deinerseits.
          </p>
        </div>
        <div class="lp-local-stats">
          <div class="stat-card">
            <div class="stat-number">${city.businesses}</div>
            <div class="stat-label">Unternehmen in ${city.name}</div>
          </div>
          <div class="stat-card">
            <div class="stat-number">94%</div>
            <div class="stat-label">Kaufentscheidungen starten online</div>
          </div>
          <div class="stat-card">
            <div class="stat-number">3–6</div>
            <div class="stat-label">Monate bis zum ersten Ranking</div>
          </div>
          <div class="stat-card">
            <div class="stat-number">0</div>
            <div class="stat-label">Stunden Aufwand für dich</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="lp-services">
    <div class="container">
      <div class="section-header">
        ...
        <h2>Content-Pakete für KMUs in ${city.name}</h2>
        <p class="section-sub">Monatlich geliefert. Veröffentlichungsfertig. Vollständig auf deine Branche zugeschnitten.</p>
      </div>
      <div class="services-grid">
        <div class="service-card reveal">
          <div class="service-icon">📝</div>
          <h3>SEO Blog-Artikel</h3>
          <p>5–12 Blogartikel pro Monat, jeder mit Keyword-Recherche, H1–H3-Struktur, Meta-Beschreibung und internen Verlinkungsvorschlägen. Mindestens 800 Wörter, branchenspezifisch geschrieben.</p>
        </div>
        <div class="service-card reveal reveal-delay-1">
          <div class="service-icon">🤖</div>
          <h3>GEO-Optimierung</h3>
          <p>Jeder Artikel ist für KI-Suchmaschinen wie ChatGPT, Perplexity und Google AI Overviews optimiert. Klare Aussagen, strukturierte Antworten, Fakten — damit du in KI-Ergebnissen zitiert wirst.</p>
        </div>
        <div class="service-card reveal reveal-delay-2">
          <div class="service-icon">📊</div>
          <h3>Monatliches Reporting</h3>
          <p>Ab dem Standard-Paket: monatlicher Report mit Sichtbarkeits-Entwicklung, Top-Rankings deiner Artikel und Empfehlungen für den nächsten Monat.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="lp-process">
    <div class="container">
      <div class="section-header">
        <div class="section-badge">So funktioniert es</div>
        <h2>Von der Anfrage zur fertigen Lieferung</h2>
      </div>
      <div class="process-steps lp-process-steps">
        <div class="process-step reveal">
          <div class="process-number">01</div>
          <h3>Onboarding (einmalig, 10 Min.)</h3>
          <p>Du füllst einmal ein kurzes Formular aus: Branche, Zielgruppe, Keywords, Tonalität. Das war's.</p>
        </div>
        <div class="process-arrow" aria-hidden="true">→</div>
        <div class="process-step reveal reveal-delay-1">
          <div class="process-number">02</div>
          <h3>Produktion (7 Werktage)</h3>
          <p>Wir produzieren deine Artikel vollautomatisch, prüfen sie und optimieren für SEO und GEO.</p>
        </div>
        <div class="process-arrow" aria-hidden="true">→</div>
        <div class="process-step reveal reveal-delay-2">
          <div class="process-number">03</div>
          <h3>Lieferung (monatlich)</h3>
          <p>Du erhältst alle Artikel als Word-Dateien. Einfach kopieren und in dein CMS oder Blog einfügen.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- BRANCHEN -->
  <section class="lp-industries">
    <div class="container">
      <div class="section-header">
        <div class="section-badge">Für wen</div>
        <h2>Content für diese Branchen in ${city.name}</h2>
      </div>
      <div class="industries-grid">
        <div class="industry-pill">⚖️ Anwälte &amp; Steuerberater</div>
        <div class="industry-pill">🦷 Zahnärzte &amp; Ärzte</div>
        <div class="industry-pill">🔧 Handwerksbetriebe</div>
        <div class="industry-pill">🏋️ Coaches &amp; Berater</div>
        <div class="industry-pill">🛍️ E-Commerce Shops</div>
        <div class="industry-pill">🏗️ Immobilienmakler</div>
        <div class="industry-pill">💆 Beauty &amp; Wellness</div>
        <div class="industry-pill">🍕 Gastronomie</div>
        <div class="industry-pill">🏫 Bildungseinrichtungen</div>
        <div class="industry-pill">🚗 KFZ-Betriebe</div>
        <div class="industry-pill">💻 IT-Dienstleister</div>
        <div class="industry-pill">📦 Logistik &amp; Transport</div>
      </div>
    </div>
  </section>
  ...
  <section class="lp-pricing" id="preise">
    <div class="container">
      <div class="section-header">
        ...
        <h2>Transparente Pakete für ${city.name}er KMUs</h2>
        <p class="section-sub">Alle Pakete monatlich kündbar. Kein Jahresvertrag. Keine versteckten Kosten.</p>
      </div>
      <div class="pricing-grid">
        <div class="pricing-card reveal">
          ...
          <ul class="pricing-features">
            ...
            <li><span class="check" aria-hidden="true">✓</span> GEO-Optimierung inklusive</li>
            ...
            <li><span class="check" aria-hidden="true">✓</span> Lieferung als Word-Datei</li>
          </ul>
          <a href="https://tally.so/r/ODkbAk" class="btn btn-outline btn-full"
             target="_blank" rel="noopener noreferrer" id="starter-cta-${city.slug}">Starter anfragen</a>
        </div>
        <div class="pricing-card pricing-popular reveal reveal-delay-1">
          ...
          <ul class="pricing-features">
            ...
            <li><span class="check" aria-hidden="true">✓</span> Keyword-Recherche</li>
            <li><span class="check" aria-hidden="true">✓</span> Meta-Beschreibungen</li>
            <li><span class="check" aria-hidden="true">✓</span> Monatliches Ranking-Reporting</li>
            <li><span class="check" aria-hidden="true">✓</span> Prioritäts-Support</li>
          </ul>
          <a href="https://tally.so/r/ODkbAk" class="btn btn-primary btn-full"
             target="_blank" rel="noopener noreferrer" id="standard-cta-${city.slug}">Standard anfragen</a>
        </div>
        <div class="pricing-card reveal reveal-delay-2">
          ...
          <ul class="pricing-features">
            ...
            <li><span class="check" aria-hidden="true">✓</span> Meta-Beschreibungen</li>
            <li><span class="check" aria-hidden="true">✓</span> Monatliches Reporting + Call</li>
            <li><span class="check" aria-hidden="true">✓</span> Persönlicher Ansprechpartner</li>
          </ul>
          <a href="https://tally.so/r/ODkbAk" class="btn btn-outline btn-full"
             target="_blank" rel="noopener noreferrer" id="premium-cta-${city.slug}">Premium anfragen</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- FAQ LOKAL -->
  <section class="faq-section lp-faq">
    <div class="container">
      <div class="section-header">
        <div class="section-badge">FAQ</div>
        <h2>Häufige Fragen von KMUs aus ${city.name}</h2>
      </div>
      <div class="faq-list">
        <div class="faq-item">
          <button class="faq-question" aria-expanded="false">
            Arbeitet ihr auch für Unternehmen außerhalb von ${city.name}?
            <svg class="faq-icon" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
          </button>
          <div class="faq-answer">
            <p>Ja — ranktext ist vollständig remote. Wir liefern Content für KMUs in ganz Deutschland, Österreich und der Schweiz. Der Standort deines Unternehmens spielt keine Rolle, solange du in einem deutschsprachigen Markt tätig bist.</p>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-question" aria-expanded="false">
            Wie schnell sehe ich erste Ergebnisse bei Google?
            <svg class="faq-icon" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
          </button>
          <div class="faq-answer">
            <p>SEO braucht Zeit — das ist eine Grundtatsache. Erste Ranking-Bewegungen sind typischerweise nach 2–3 Monaten zu sehen, messbare Traffic-Steigerungen nach 4–6 Monaten. Wer jetzt anfängt, hat in einem halben Jahr einen signifikanten Vorsprung gegenüber Mitbewerbern, die noch warten.</p>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-question" aria-expanded="false">
            Was passiert wenn mir die Artikel nicht gefallen?
            <svg class="faq-icon" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
          </button>
          <div class="faq-answer">
            <p>Wir überarbeiten jeden Artikel kostenlos, bis du zufrieden bist. Außerdem ist das Paket monatlich kündbar — du gehst kein Risiko ein. Wenn du nach dem ersten Monat nicht überzeugt bist, kannst du jederzeit kündigen.</p>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-question" aria-expanded="false">
            Wie viel Aufwand habe ich als Kunde?
            <svg class="faq-icon" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
          </button>
          <div class="faq-answer">
            <p>Einmalig ca. 10 Minuten für das Onboarding-Formular (Branche, Zielgruppe, Keywords). Danach nur noch die monatliche Lieferung empfangen und Artikel in dein CMS einfügen — das dauert ca. 30–60 Minuten pro Monat. Den Rest erledigt ranktext vollautomatisch.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="cta-section lp-cta">
    <div class="container">
      <div class="cta-inner">
        <div class="section-badge" style="display:inline-flex;margin-bottom:20px;">Für ${city.name}er KMUs</div>
        <h2>Starte heute — deine Mitbewerber warten nicht</h2>
        <p style="color:var(--text-secondary);max-width:520px;margin:0 auto 32px;line-height:1.7;">
          Jeder Monat ohne Content ist ein Monat, in dem deine Mitbewerber in ${city.name} aufholen. Der beste Zeitpunkt zu starten war vor 6 Monaten. Der zweitbeste ist jetzt.
        </p>
        <a href="https://tally.so/r/ODkbAk" class="btn btn-primary btn-lg"
           target="_blank" rel="noopener noreferrer" id="final-cta-${city.slug}">
          Jetzt Paket anfragen – kostenlos &amp; unverbindlich
          <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg>
        </a>
        <p style="color:var(--text-muted);font-size:0.8rem;margin-top:16px;">Monatlich kündbar · Kein Jahresvertrag · Antwort innerhalb 24h</p>
      </div>
    </div>
  </section>
...
<footer id="footer" role="contentinfo">
  <div class="container">
    <div class="footer-bottom">
      <p>© 2026 ranktext · Sebastian Galwas · Ernst-Reuter-Str. 33–37, 50354 Hürth · <a href="mailto:hallo@ranktext.de">hallo@ranktext.de</a></p>
      <nav class="footer-legal-links" aria-label="Rechtliche Links">
...
const outputDir = path.join(__dirname, 'landingpages');
if (!fs.existsSync(outputDir)) {
  fs.mkdirSync(outputDir, { recursive: true });
}

// Alle 50 Seiten generieren
let generated = 0;
cities.forEach(city => {
  const html = generatePage(city);
  const filename = `content-agentur-${city.slug}.html`;
...
// Sitemap generieren
const sitemapUrls = cities.map(city => `
  <url>
    <loc>https://www.ranktext.de/landingpages/content-agentur-${city.slug}.html</loc>
...
// Landingpage-Index generieren
const indexLinks = cities.map(city =>
  `<li><a href="content-agentur-${city.slug}.html">Content Agentur ${city.name}</a></li>`
).join('\n        ');
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Content Agentur Deutschland – Alle Städte | ranktext</title>
  <meta name="description" content="ranktext liefert SEO & GEO Content für KMUs in ganz Deutschland. Alle Städte im Überblick.">
  <link rel="canonical" href="https://www.ranktext.de/landingpages/">
  <link rel="stylesheet" href="../css/style.css">
</head>
<body>
...
<main>
  <div class="container" style="padding-top:120px;padding-bottom:80px;">
    <h1 style="margin-bottom:32px;">Content Agentur – Alle Städte</h1>
    <ul style="columns:3;column-gap:40px;list-style:none;padding:0;">
        ${indexLinks}
    </ul>
  </div>
</main>
<footer id="footer"><div class="container"><div class="footer-bottom">
  <p>© 2026 ranktext · <a href="../datenschutz.html">Datenschutz</a> · <a href="../impressum.html">Impressum</a></p>
</div></div></footer>
<script src="../js/main.js"></script>
</body>
</html>`;
...
console.log(`\n🎉 Fertig! ${generated} Landingpages + sitemap.xml + index generiert`);
